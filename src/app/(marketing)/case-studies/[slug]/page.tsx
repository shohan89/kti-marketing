...
export default async function CaseStudyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { tag, category, industry, client, title, subtitle, challenge, solution, phases, deliverables, metrics, duration, services, quote, quoteName, quoteRole, quoteCompany, quoteResult } = study
      ...
      <section className="csd-hero">
        ...
        <div className="container csd-hero__inner">
          <nav className="csd-breadcrumb" aria-label="Breadcrumb">
            <Link href="/case-studies">Case Studies</Link><span aria-hidden="true">›</span><span>{client}</span>
          </nav>
        ...
        <div className="container">
          ...
          <div className="csd-more__grid">
            {related.map(({ slug: relSlug, tag: relTag, client: relClient, title: relTitle, metrics: relMetrics }) => (
              <Link href={`/case-studies/${relSlug}`} className="csd-more-card" key={relSlug}>
