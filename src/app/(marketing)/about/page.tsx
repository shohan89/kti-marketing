...
const TEAM_STATIC = [
  { name: 'Tanvir Ahmed', role: 'Creative Director', initials: 'TA', gradient: 'linear-gradient(135deg, #D7262E 0%, #9B1C22 100%)', bio: 'Leads all creative output — from campaign concepts to final delivery — ensuring every piece is visually compelling and on-brand.', socials: { linkedin: '#', instagram: '#', email: 'tanvir@ktimarketing.com' } },
  { name: 'Sadia Islam', role: 'Social Media Strategist', initials: 'SI', gradient: 'linear-gradient(135deg, #7C3AED 0%, #4C1D95 100%)', bio: 'Builds and manages social presence across platforms, crafting content strategies that turn followers into loyal brand communities.', socials: { linkedin: '#', instagram: '#', email: 'sadia@ktimarketing.com' } },
  { name: 'Rafiqul Islam', role: 'Content & Copy Lead', initials: 'RI', gradient: 'linear-gradient(135deg, #0891B2 0%, #0E4F6B 100%)', bio: 'Crafts persuasive copy and editorial content that resonates with audiences, drives engagement, and supports every stage of the funnel.', socials: { linkedin: '#', instagram: '#', email: 'rafiq@ktimarketing.com' } },
  { name: 'Nadia Rahman', role: 'Graphic Designer', initials: 'NR', gradient: 'linear-gradient(135deg, #D97706 0%, #92400E 100%)', bio: 'Translates brand identities into striking visuals — from social graphics and ads to packaging and brand guidelines.', socials: { linkedin: '#', instagram: '#', email: 'nadia@ktimarketing.com' } },
  { name: 'Shahriar Hossain', role: 'Video Editor', initials: 'SH', gradient: 'linear-gradient(135deg, #059669 0%, #065F46 100%)', bio: 'Edits and produces video content for ads, reels, and campaigns — bringing stories to life through motion, pacing, and sound.', socials: { linkedin: '#', instagram: '#', email: 'shahriar@ktimarketing.com' } },
  { name: 'Rashida Khatun', role: 'Digital Ads Manager', initials: 'RK', gradient: 'linear-gradient(135deg, #DB2777 0%, #831843 100%)', bio: 'Plans and optimises paid campaigns across Meta, Google, and TikTok — maximising ROAS and scaling what works.', socials: { linkedin: '#', instagram: '#', email: 'rashida@ktimarketing.com' } },
]
  ...
  try {
    ...
    if (rows.length > 0) {
      team = rows.map((m, i) => ({
        ...
        socials: { linkedin: m.linkedinUrl ?? null, instagram: null, email: null },
      }))
    }
