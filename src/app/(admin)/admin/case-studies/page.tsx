  ...
  return (
    <>
      <div className="admin-page-header">
        <div><h1 className="admin-page-title">Case Studies</h1><p className="admin-page-sub">{studies.length} case studies</p></div>
        <Link href="/admin/case-studies/new" className="admin-btn admin-btn--primary">+ New Case Study</Link>
      </div>
              ...
              <tr key={cs.id}>
                ...
                <td>
                  <div className="admin-actions">
                    <Link href={`/admin/case-studies/${cs.id}/edit`} className="admin-btn admin-btn--outline admin-btn--sm">Edit</Link>
                    <Link href={`/case-studies/${cs.slug}`} className="admin-btn admin-btn--outline admin-btn--sm" target="_blank">View ↗</Link>
                  </div>
                </td>
              </tr>
            ))}
