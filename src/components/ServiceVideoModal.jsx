...
import './ServiceVideoModal.css'

export default function ServiceVideoModal({ service, onClose }) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={`${service.title} overview video`}
    >
      <div className="svm-dialog">
        ...
        <div className="svm-video-wrap">
          {service.videoUrl ? (
            <iframe
              className="svm-iframe"
              src={`${service.videoUrl}?autoplay=1&rel=0&modestbranding=1`}
