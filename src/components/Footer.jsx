          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <p className="footer-tagline">
                A results-obsessed, full-service marketing agency building brands
            ...
            <div className="footer-col">
              ...
              <ul className="footer-contact-list">
                <li>
                  <a href="mailto:hello@ktimarketing.com">hello@ktimarketing.com</a>
                </li>
                <li>
                  <a href="tel:+15552345678">+1 (555) 234-5678</a>
                </li>
                <li className="footer-address">
                  123 Marketing Ave<br />New York, NY 10001
                </li>
              </ul>
